...
### pi-pi interactions
To analyse all pi-pi interactions associated with the asymmetric unit automatically type pipi -g. Type fuse to return to the asymmetric unit. This is also available under View | Geometry | Analyse pi-pi Interactions.
...
- Short Contacts displays growable 'bonds' to those atoms where 'short interactions' exist, alternatively type mode grow -s. Press ESC to exit the mode. If an atom is selected first only short interactions to that atom are shown.
